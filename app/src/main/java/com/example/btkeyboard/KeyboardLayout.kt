...
sealed class KeyboardLayout(val name: String, val rows: List<List<KeyInfo>>, val isSplit: Boolean = false, val splitRows: List<SplitRows> = emptyList()) {
    ...
    object ThumbQwerty : KeyboardLayout("T-QWERTY", emptyList(), true, listOf(
        ...
        SplitRows(
            ...
            listOf(KeyInfo("6", HidKeyCodes.KEY_6, shiftedLabel = "^"), KeyInfo("7", HidKeyCodes.KEY_7, shiftedLabel = "&"), KeyInfo("8", HidKeyCodes.KEY_8, shiftedLabel = "*"), KeyInfo("9", HidKeyCodes.KEY_9, shiftedLabel = "("), KeyInfo("0", HidKeyCodes.KEY_0, shiftedLabel = ")"), KeyInfo("-", HidKeyCodes.KEY_MINUS, shiftedLabel = "_"), KeyInfo("=", HidKeyCodes.KEY_EQUAL, shiftedLabel = "+"))
        ),
        SplitRows(
        ...
        SplitRows(
            ...
            listOf(KeyInfo("h", HidKeyCodes.KEY_H, shiftedLabel = "H"), KeyInfo("j", HidKeyCodes.KEY_J, shiftedLabel = "J"), KeyInfo("k", HidKeyCodes.KEY_K, shiftedLabel = "K", fnLabel = "Stick"), KeyInfo("l", HidKeyCodes.KEY_L, shiftedLabel = "L"), KeyInfo(";", HidKeyCodes.KEY_SEMICOLON, shiftedLabel = ":"), KeyInfo("'", HidKeyCodes.KEY_APOSTROPHE, shiftedLabel = "\""), KeyInfo("\\", HidKeyCodes.KEY_BACKSLASH, shiftedLabel = "|"))
        ),
        SplitRows(
    ...
    object ThumbQwertz : KeyboardLayout("T-QWERTZ", emptyList(), true, listOf(
        ...
        SplitRows(
            listOf(KeyInfo("^", HidKeyCodes.KEY_GRAVE, shiftedLabel = "°"), KeyInfo("1", HidKeyCodes.KEY_1, shiftedLabel = "!"), KeyInfo("2", HidKeyCodes.KEY_2, shiftedLabel = "\""), KeyInfo("3", HidKeyCodes.KEY_3, shiftedLabel = "§"), KeyInfo("4", HidKeyCodes.KEY_4, shiftedLabel = "$"), KeyInfo("5", HidKeyCodes.KEY_5, shiftedLabel = "%")),
            listOf(KeyInfo("6", HidKeyCodes.KEY_6, shiftedLabel = "&"), KeyInfo("7", HidKeyCodes.KEY_7, shiftedLabel = "/"), KeyInfo("8", HidKeyCodes.KEY_8, shiftedLabel = "("), KeyInfo("9", HidKeyCodes.KEY_9, shiftedLabel = ")"), KeyInfo("0", HidKeyCodes.KEY_0, shiftedLabel = "="), KeyInfo("ß", HidKeyCodes.KEY_MINUS, shiftedLabel = "?"), KeyInfo("´", HidKeyCodes.KEY_EQUAL, shiftedLabel = "`"))
        ),
        SplitRows(
            listOf(KeyInfo("Tab", HidKeyCodes.KEY_TAB, 1.2f), KeyInfo("q", HidKeyCodes.KEY_Q, shiftedLabel = "Q"), KeyInfo("w", HidKeyCodes.KEY_W, shiftedLabel = "W"), KeyInfo("e", HidKeyCodes.KEY_E, shiftedLabel = "E"), KeyInfo("r", HidKeyCodes.KEY_R, shiftedLabel = "R"), KeyInfo("t", HidKeyCodes.KEY_T, shiftedLabel = "T")),
        ...
        SplitRows(
            listOf(KeyInfo("Caps", HidKeyCodes.KEY_CAPS_LOCK, 1.5f), KeyInfo("a", HidKeyCodes.KEY_A, shiftedLabel = "A"), KeyInfo("s", HidKeyCodes.KEY_S, shiftedLabel = "S"), KeyInfo("d", HidKeyCodes.KEY_D, shiftedLabel = "D"), KeyInfo("f", HidKeyCodes.KEY_F, shiftedLabel = "F"), KeyInfo("g", HidKeyCodes.KEY_G, shiftedLabel = "G")),
            listOf(KeyInfo("h", HidKeyCodes.KEY_H, shiftedLabel = "H"), KeyInfo("j", HidKeyCodes.KEY_J, shiftedLabel = "J"), KeyInfo("k", HidKeyCodes.KEY_K, shiftedLabel = "K", fnLabel = "Stick"), KeyInfo("l", HidKeyCodes.KEY_L, shiftedLabel = "L"), KeyInfo("ö", HidKeyCodes.KEY_SEMICOLON, shiftedLabel = "Ö"), KeyInfo("ä", HidKeyCodes.KEY_APOSTROPHE, shiftedLabel = "Ä"), KeyInfo("#", HidKeyCodes.KEY_BACKSLASH, shiftedLabel = "'"))
        ),
        SplitRows(
            listOf(KeyInfo("Shift", HidKeyCodes.KEY_NONE, 1.3f, true, HidKeyCodes.MOD_LEFT_SHIFT), KeyInfo("<", 0x64.toByte(), shiftedLabel = ">"), KeyInfo("y", HidKeyCodes.KEY_Z, shiftedLabel = "Y"), KeyInfo("x", HidKeyCodes.KEY_X, shiftedLabel = "X"), KeyInfo("c", HidKeyCodes.KEY_C, shiftedLabel = "C"), KeyInfo("v", HidKeyCodes.KEY_V, shiftedLabel = "V")),
            listOf(KeyInfo("b", HidKeyCodes.KEY_B, shiftedLabel = "B"), KeyInfo("n", HidKeyCodes.KEY_N, shiftedLabel = "N"), KeyInfo("m", HidKeyCodes.KEY_M, shiftedLabel = "M"), KeyInfo(",", HidKeyCodes.KEY_COMMA, shiftedLabel = ";"), KeyInfo(".", HidKeyCodes.KEY_DOT, shiftedLabel = ":"), KeyInfo("-", HidKeyCodes.KEY_SLASH, shiftedLabel = "_"), KeyInfo("Shift", HidKeyCodes.KEY_NONE, 2.0f, true, HidKeyCodes.MOD_RIGHT_SHIFT))
        ),
        SplitRows(
            listOf(KeyInfo("Ctrl", HidKeyCodes.KEY_NONE, 1.2f, true, HidKeyCodes.MOD_LEFT_CTRL), KeyInfo("Fn", HidKeyCodes.KEY_NONE, 1.0f, isFn = true), KeyInfo("Alt", HidKeyCodes.KEY_NONE, 1.0f, true, HidKeyCodes.MOD_LEFT_ALT), KeyInfo("Space", HidKeyCodes.KEY_SPACE, 3f)),
